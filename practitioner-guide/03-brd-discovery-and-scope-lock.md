...
This is worth stating plainly, because nothing in `gen-brd.md` says it explicitly: **each Section 5.N feature-area heading becomes one epic, 1:1, when `/gen-epics` runs.** This isn't an editorial convenience grouping you can rearrange freely later — it's a mechanical mapping, consistent with `SDLC.md` Stage 4's description of epics as "cohesive delivery units, each representing a complete, independently useful capability."
