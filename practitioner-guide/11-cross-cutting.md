...
**The test, mirrored on the same logic [`FW-024`](../decisions/FW-024-parking-lot-deferred-capabilities.md)'s Parking Lot test already taught you in [Chapter 3](03-brd-and-scope-lock.md#section-521-future-capabilities-vs-section-15-parking-lot-the-actual-test):**
