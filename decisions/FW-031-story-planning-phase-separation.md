...
| **Area** | New: `gen-story-plan.md`, `story-plan.template.md`. Changed: `implement-story.md`, `verify-story.md`, `update-status.md`, `init-project.md`, [`CLAUDE.md`](../CLAUDE.md), [`PROJECT-LIFECYCLE.md`](../PROJECT-LIFECYCLE.md), [`SDLC.md`](../SDLC.md) |
...
- [`CLAUDE.md`](../CLAUDE.md), [`PROJECT-LIFECYCLE.md`](../PROJECT-LIFECYCLE.md), [`SDLC.md`](../SDLC.md): command count 29 → 30; new Step 17a in the lifecycle table and Stage 8 description; Story Plan added to the Status Values Reference
