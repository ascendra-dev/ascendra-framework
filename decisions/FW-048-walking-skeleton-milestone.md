...
- [x] `practitioner-guide/04-product-structuring.md` — new section "The Walking Skeleton: a harder constraint than ordinary dependency ordering," a Common Mistakes bullet, and a Harborview-in-practice addition citing `epic.example.md`'s real REQ-001 tag and the EPIC-001/EPIC-003 split
