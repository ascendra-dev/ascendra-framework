...
- **`FW-049`** — this is the deferred second priming-producing command its own §5.11 named; governed by the same [`conventions/priming-command-conventions.md`](../conventions/priming-command-conventions.md) contract, contributing to the same `priming-package.md`.
