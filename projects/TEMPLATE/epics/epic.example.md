...
*Generated by `/judgment-check` against `practitioner-guide/04-product-structuring-epics.md` on 2026-07-12. Findings are questions raised by the guide's own tests, not verdicts. This worked example demonstrates the section's shape — a real project's findings will differ.*
