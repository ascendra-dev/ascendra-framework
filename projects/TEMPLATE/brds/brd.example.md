...
*Generated by `/judgment-check` against `practitioner-guide/03-brd-and-scope-lock.md` on 2026-07-10. Findings are questions raised by the guide's own tests, not verdicts. This worked example demonstrates the section's shape — a real project's findings will differ.*
